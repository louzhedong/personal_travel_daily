import type { PhotoCurationItemDto } from './photos.js';
...
export interface UpdatePhotoAlbumPreferenceInputDto {
  targetKind: PhotoAlbumPreferenceTargetKindDto;
  targetId: string;
  pinnedImageIds?: string[];
  sortOrder?: string[];
...
export interface UpdatePhotoAlbumPreferencesInputDto {
  preferences: UpdatePhotoAlbumPreferenceInputDto[];
}
